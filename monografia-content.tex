...
LCOM é calculado da seguinte forma, considere C1 uma classe com M1, M2,
...
O extrator atual do egypt, {\it Egypt::Extractor}, entende apenas arquivos
...
como chamadas a biblioteca GTK (GIMP Tool Kit)\sigla{GTK}{GIMP Tool
Kit} por exemplo. O Doxyparse não foi afetado por este erro pois a chamada a
...
novo extrator o {\it egypt} ganhou algumas melhorias e correção de bugs.
