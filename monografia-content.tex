...
guarda-se main::parent\_class. Na figura \ref{ristretto-0.0.11-doxyparse-2} na página \pageref{ristretto-0.0.11-doxyparse-2} temos o gráfico atualizado após a correcão feita no egypt.
...
já no Doxyparse não há esta chamada. E de fato, analisando o código fonte do ristretto 0.0.11 não foi encontrado nenhuma chamada de main\_window para main.
