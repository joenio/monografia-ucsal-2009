...
necessidade de usar o GCC\sigla{GCC}{GNU C Compiler} ou qualquer outro
compilador. Com isto será possível analisar projetos que não compilem mais,
seja por falhas no código ou por possuir dependencias não satisfeitas. Além
disto, este novo extrator trará mais duas vantagens: primeiro, o tempo
...
Como o objetivo deste trabalho é o extrator baseado no doxyparse faz-se
...
como identificador único, o nome do símbolo em questão (função ou variável por
exemplo) mas alguns módulos possuem símbolos com o mesmo nome, isto faz com que
o egypt confunda o uso e chamada desses símbolos.
