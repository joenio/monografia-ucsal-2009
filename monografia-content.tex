...
Esta extensão para o egypt além de possibilitar analisar projetos que não
...
\citeonline{engenhariaDeSoftwarePressman} destaca 3 razões principais da
...
Apesar de Pressman, aqui, destacar a importancia da arquitetura de software apenas nas
...
\cite{sourceVersusObjectCodeExtraction}, então é importante ter a arquitetura
documentada como forma apoio para os desenvolvedores e novos colaboradores.
