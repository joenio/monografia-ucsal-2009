...
% <Osvaldo> Deixar este paragrafo acima mais motivador/justificativa
...
% <Osvaldo> Mais exemplos de arquitetura de software
%           mais modelos de arq.
...
% <Osvaldo> Falar mais sobre essas métricas
...
% <Osvaldo> Fundamentar mais a escolha
...
% <Osvaldo> Quais são as modificações dos itens acima?
...
% <Neiva> Arquitetura/requisitos - adicionar grafo com estrutura final e relacao entre egypt e doxyparse
...
% <Neiva> Não ficou claro o que você fez exatamente.
%         Exemplificar com trechos de código que eu fiz
%         Separar o que estava pronto do que foi feito por mim
% Sobre os resultados: Seria possível produzir os grafos manualmente?
% qual o tamanho do ristretto (SLOC) ele é mto grande?

% <Osvaldo> Deixar claro qual a sua produção
