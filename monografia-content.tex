...
Na figura~\ref{ristretto-0.0.1-gcc} vemos que o extrator GCC encontra uma chamada do o módulo {\it navigator} para o módulo {\it picture\_viewer}, e na figura~\ref{ristretto-0.0.1-doxyparse} o extrator Doxyparse não encontra esta chamada e sim uma chamada de {\it navigator} para {\it thumbnail\_viewer}.
...
\subsection{ristretto 0.0.11}

\subsection{ristretto 0.0.21}
