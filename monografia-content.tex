...
%O egypt é uma ferramenta originalmente escrita com o objetivo
%de gerar gráficos de chamada entre funções de programas escritos em C e que usa
%como base código objeto, ele será visto com mais detalhes na
